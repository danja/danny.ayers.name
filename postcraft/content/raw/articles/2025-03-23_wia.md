...
**Informal version for Signor Briccoli**
...
A lot of fragments, but there is an overall structure of sort. `hyperdata.it` is the uber-umbrella for code things. It's all in github somewhere. Naming underneath that, for *internal purposes*.
